...
for dataset_name in dataset_name_ls:
    ...
    for _ in range(top_k):
        ...
        test_acc_rst_ls = random_baseline(run_config, runtimes=10, k=_)
    ...
    for _ in range(top_k):
        ...
        plt.scatter(_, degree_idx_test_acc_ls[_], color='blue', s=100, label='Degree Acc')
    ...
    csv_path = f"random_baseline/{dataset_name}_undirected+degree_random_baseline.csv"
